...
cc.Class({
    ...
    prepare:function(filename){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoiceRecorder", "prepare", "(Ljava/lang/String;)V",filename);
        }
    ...
    release:function(){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoiceRecorder", "release", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    cancel:function(){
        ...
        cc.vv.audioMgr.resumeAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoiceRecorder", "cancel", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    play:function(filename, time){
        ...
        cc.vv.audioMgr.pauseAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoicePlayer", "play", "(Ljava/lang/String;)V",filename);
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    stop:function(){
        ...
        cc.vv.audioMgr.resumeAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoicePlayer", "stop", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    getVoiceLevel:function(maxLevel){
        ...
        if (cc.sys.isNative) {
            if(cc.sys.os == cc.sys.OS_ANDROID){
                return jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoiceRecorder", "getVoiceLevel", "(I)I",maxLevel);
            }
            else if(cc.sys.os == cc.sys.OS_IOS){
                return Math.floor(Math.random() * maxLevel + 1);
            }
    ...
    setStorageDir:function(dir){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){ 
            jsb.reflection.callStaticMethod("com/chesscard/voicesdk/VoiceRecorder", "setStorageDir", "(Ljava/lang/String;)V",dir);
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
