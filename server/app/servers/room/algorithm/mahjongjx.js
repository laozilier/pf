...
let pokers = [
    ...
    [
        ...
        8,9,9,33,36,33,			            //万子
        25,26,35,34,					    //筒子
        17,18,19,37,35,34,			    //万子
        6,7,36,33,					    //索子
        17,18,19,31,32				//万子
        ,26,35,31,35,			        //索子
        21,27,28,29,5,6,7,8,9,33,37,					    //索子
        24,25,26,8,27,32,36,					    //筒子
        24,25,28,29,1,2,34,31					    //索子
    ],
...
mahjong_alg.mj_wik_bai_action_type = {
    BAI_NUM:  0,
    BAI_MING: 1,
    BAI_AN:   2
};
...
mahjong_alg.mj_xiao_hu_action =  {
    ...
    XIAO_HU_YITIAOLONG      : 0x0002,               //todo 一条龙
    XIAO_HU_QIZI_QUAN       : 0x0004,               //todo 七字全         pai
    XIAO_HU_SHI_S_LAN       : 0x0008,               //todo 十三烂
    XIAO_HU_SHI_S_YAO       : 0x0010,               //todo 十四幺
    XIAO_HU_SI_BAO_PAI      : 0x0020,               //todo 四宝牌       pai
...
mahjong_alg.mj_hu_action =  {
    ...
    CHR_YI_TIAO_LONG  		:	0x00000400,									//todo 一条龙
    CHR_QI_ZI_QUAN		    :	0x00000800,									//todo 七字全
    CHR_DI_HU			    :	0x00001000,									//地胡 2
    CHR_SHI_SI_YAO 	        :	0x00002000,									//todo 十四幺
    CHR_TIAN_HU     		:	0x00004000,									//天胡 3
    CHR_YIAO_REN    	    :	0x00008000,									//todo 幺仁
    CHR_SI_QIA          	:	0x00010000,									//todo 死掐
    CHR_SHI_SAN_LAN		    :	0x00020000,									//todo 十三烂
    CHR_BAOTING_HU		    :	0x00040000,									//报听胡   (报听不能换牌) 2
    CHR_XIAO_SA 		    :	0x00080000,									//todo 潇洒
    CHR_MING_BAI		    :	0x00100000,									//todo 明摆
...
mahjong_alg.TING_MODE = {
    TING_QIN_YI_SE:     0x0001,
    TING_QI_XIAO_DUI:   0x0002,
    TING_HAO_QI:        0x0004,
    TING_YAO_REN:       0x0008,
    TING_PEMG_PENG:     0x0010
};
...
mahjong_alg.GetUserActionRank = function(cbUserAction) {
        ...
        if ((cbUserAction & self.mj_wik_action.WIK_XIAO_HU) > 0) { return 7; }

        //todo 胡牌
        if ((cbUserAction & self.mj_wik_action.WIK_CHI_HU) > 0) { return 6; }

        //todo 摆牌
        if ((cbUserAction & self.mj_wik_action.WIK_BAI) === self.mj_wik_action.WIK_BAI) { return 5; }
